...
enum QuestionClassifier: Sendable {
    ...
    static let sectionRules: [String: [Rule]] = [
        ...
        "言语理解|阅读理解": [
            ...
            Rule(name: "主旨与意图", patterns: ["意在|想要|想表达|旨在|启示|告诉|意图|强调|反映.*问题|主要说明|主要讲述|主要谈论|主旨|概括|中心|主要观点|主要内容|说明的是|谈论|说明了|主要介绍|介绍了|复述|关键词|重在"]),
            Rule(name: "主旨与意图", patterns: [
        ...
        "言语理解|语句表达": [
            ...
            Rule(name: "接语选择", patterns: ["横线|填入.*句子|衔接|承上启下|空格|语意连贯|括号"]),
        ],
        "数字运算|数字推理": [
            ...
            Rule(name: "数字拆分", patterns: ["图形数阵|数阵|图中|图形|机械划分|因式分解|小数数列|拆分|小数点|个位.*十位|数位"]),
        ...
        "数字运算|数量关系": [
            ...
            Rule(name: "日期与周期", patterns: ["钟表|时针|分针|钟面|敲钟|挂钟"]),
            ...
            Rule(name: "和差倍比与方程", patterns: ["平均分|平均数|平均成绩|总平均"]),
        ...
        "数字运算|数字运算": [
            ...
            Rule(name: "数字拆分", patterns: ["三位数|两位数|三位数|四位数|个位|十位|百位|位数|数字|页码|书页|号码|数位"]),
        ],
        "逻辑推理|逻辑判断": [
        ...
        "逻辑推理|类比推理": [
            ...
            Rule(name: "语义关系", patterns: ["词性|动宾|主谓|偏正|语法|成语结构|名词|形容词|修饰|主宾"]),
        ],
