...
// Pure HTML/JSON parsing helpers for the upstream platform. The lanjing-web
// repo keeps a deliberate separate copy of this module (lib/parsers.js)
// because this tool runs standalone, without the web app. Keep the two in
// sync when changing.
